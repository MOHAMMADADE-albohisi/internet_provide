...
class regesteruser_screen extends StatefulWidget {
  const regesteruser_screen({Key? key}) : super(key: key);

  @override
  State<regesteruser_screen> createState() => _regesteruser_screenState();
}

class _regesteruser_screenState extends State<regesteruser_screen> {
  late TextEditingController _email;
  late TextEditingController _regester;
  late TextEditingController _password;
  late TapGestureRecognizer _click;
  bool _viewpassword = true;
  bool _remember = true;
  String? _emailerror;
  String? _regestererror;
  ...
  void initState() {
    ...
    _regester = TextEditingController();
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  constraints: BoxConstraints(
                    minHeight: 50,
                    maxHeight: _regestererror == null ? 56 : 81,
                  ),
